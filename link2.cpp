...
Link2::Link2() :// Class link2 la con cua class OpenGLWindow (OpenGLWindow la class tu dinh nghia)
  ...
  , m_filepath("MelfaModel/models/MITSU - Link2-1.STL")
...
//    glClear( GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
  ...
  double c1 = cos(degJ1), s1 = sin(degJ1);
   ...
   m_DH = QMatrix4x4(c1, 0, -s1, 0,
                      s1 ,0,c1,0,
                      0,-1,0,d1,
                      0,0,0,1);
    //m_DH.rotate(degJ1, 0, 0, 1);
   // m_DH.translate(0,0,1);
   // m_DH.translate( 1, 0, 0);
   //m_DH.rotate(anpha, 1, 0, 0);
